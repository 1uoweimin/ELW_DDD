...
namespace FileService.WebAPI.Controllers.v1.Requests;
...
public class UploadRequestValidator : AbstractValidator<UploadReq>
{
    public UploadRequestValidator()
    {
        ...
        RuleFor(u => u.File).NotNull().Must(f => f.Length > 0 && f.Length < maxFileSize);
    }
}